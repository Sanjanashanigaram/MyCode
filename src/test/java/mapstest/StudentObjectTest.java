...
public class StudentObjectTest extends TestCase {
    ...
    public void testStudentObjects() {
        ...
        //true case
        assertEquals(studentobj.get("a") , ReturnStudentObject.returnStudentObj(studentobj,"a"));
        assertEquals(studentobj.get("f") , ReturnStudentObject.returnStudentObj(studentobj,"f"));

        //false case
        assertNotSame(studentobj.get("b") , ReturnStudentObject.returnStudentObj(studentobj,"a"));

        assertEquals(studentobj.get(null) , ReturnStudentObject.returnStudentObj(studentobj,null));
        assertEquals(studentobj.get(" ") , ReturnStudentObject.returnStudentObj(studentobj," "));
